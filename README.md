# The Advent of Code 2025

## What is the Advent of Code?

The Advent of Code is a yearly coding challenge hosted at https://adventofcode.com.
Challenges are released daily covering a range of coding topics in no particular difficulty order.
There are 2 stages to complete each day, often a simple and more complex spin on the same task.

## My repository

This repository contains my solutions for Advent of Code 2025, organised with one directory per day.
...
To run a day's solution with the test dataset, navigate to the directory and run `python3 solution.py`.
